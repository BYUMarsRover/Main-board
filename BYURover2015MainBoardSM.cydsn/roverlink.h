...
const static uint8_t ROVERLINK_MSG_LEN_ARRAY[] = {
...
const static uint8_t ROVERLINK_WRITE = 0xC0;
const static uint8_t ROVERLINK_REQUEST = 0x40;
const static uint8_t ROVERLINK_RESPONSE = 0x00;
