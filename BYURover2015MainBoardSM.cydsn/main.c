/*
    ...
    University Rover Challenge Rover. The Scheduler consists of a basic 5 stage 
    mechanism: read, update, read sensor, report, wait. Read, reads the top item in the incomming
    commands array. Update updates the actuators. Read sensor reads the sensor information
    Report, creates the report. Wait simply is a wait state to be used when there is nothing 
    in the IncommingCommands array.
...
//Uncomment if you want to simulate some stationary motor commands
...
/*<<< Scheduler Instatiation >>>*/
Scheduler sch;

/*<< Special putdata function >>*/
...
//UNCOMMENT THIS IF YOU WANT TO USE COMPUTER KEYBOARD TO RUN SOME TESTS
...
int main()
{
    ...
    /*end WIZNET INITIALIZATION */
    
    
    
    /* Output/Actuation Initializations */
    Wheels_1_Start();
    Wheels_2_Start();
    Gimbal_Start();
